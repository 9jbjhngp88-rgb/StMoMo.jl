function fit_StMoMo(; model=model,Dxt=nothing,Ext=nothing,Ages_fit=nothing,Wxt=nothing,Years=nothing)
    ...
    function neg_loglikelihood(params,N,Dxt,Ext,Ages_fit,Wxt,Years;modelFun=modelFun)
    ...
    x=optimize(p->neg_loglikelihood(p,N,Dxt,Ext,Ages_fit,Wxt,Years, modelFun=modelFun),X0,BFGS(); autodiff=AutoForwardDiff())  
